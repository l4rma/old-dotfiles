...
static const char *fonts[]          = { "Mononoki Nerd Font:size=12", "JoyPixels:size=10" };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_p,      spawn,          SHCMD("rofi -show run -theme gruvbox-dark") },
	{ MODKEY,                       XK_s,      spawn,          SHCMD("rofi -show emoji -modi emoji -theme gruvbox-dark") },
